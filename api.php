...
namespace Tqdev\PhpCrudApi {
    ...
    $config = new Config([
        ...
        // 'port' => '3306',
        'driver' => 'sqlite',
        // 位于nginx-1.21.3/db/  目录下
        //'address' => dirname(dirname(dirname(__FILE__))).'/db/blog.sqlite',
		'address' => './data.db',
        'username' => '',
        'password' => '',
	...
	//echo dirname(dirname(dirname(__FILE__))).'/db/blog.sqlite';
